...
* gettext (or use '-Denable-nls=false' if you only need English language support)
...
Note that uninstall does not uninstall the language files at this time.

* ninja clean (cleans the build files)
